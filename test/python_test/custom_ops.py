...
# x_attention_v2
def x_attention_v2_npu(query, key_cache, value_cache, unshared_key, unshared_value, actual_shared_kvlen, decode_step, 
                    shared_block_tables = None, 
                    unshared_block_tables = None,
                    scale_value = None):
    if scale_value is None:
        scale_value = 0.0
    return custom_ops_lib.x_attention_v2(query, key_cache, value_cache, unshared_key, unshared_value, 
                                      shared_block_tables, unshared_block_tables, actual_shared_kvlen, decode_step, scale_value)
