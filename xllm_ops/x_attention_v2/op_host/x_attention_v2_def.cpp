...
namespace ops {
class XAttentionV2 : public OpDef {
public:
    explicit XAttentionV2(const char* name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
        ...
        this->AICore().AddConfig("ascend910b");     # TODO 替换 Pro 后删除
        this->AICore().AddConfig("ascend910_93");   # TODO 替换 Pro 后删除
